    ...
    if( jQuery )
        ( function ( $ ) {
            $.fn.extend( {
                 ...
                 * @param {wallType}, default: 'carousel', //carousel,thumb,playlist
                        ...
                        for( var key in params.videos ) {
                            if( params.videos.hasOwnProperty( key ) ) {
                                ...
                                fragment.appendChild( temp.firstChild );
                                 bindPlayVideo( {
                                    wrapper : fragment.querySelector( '#' + attributes.slide_id + '> .play-wrapper' ),
                                    videoParams : {
                                        title : title,
                                        player : params.player,
                                        src : src,
...
//                    };
                    ...
                    this.createFilterInput = ( ) => {
                        ...
                        $( "#" + elemId + "-filter" ).select2( options.select2Defaults ).on( 'select2:select', function ( e ) {
                            e.preventDefault( );
            ...
            $.fn.idowsVideowall.defaults = {
                wallType : 'carousel', //slide,thumb,playlist
            ...
            $.fn.getTemplate = ( template ) => {
                let templateSelection = {
                    ...
                    carousel : ( ) => {
                        return [
                            '<div id="{{slide_id}}" class="wall-slide mode-{{mode}} {{status}}" style="background: url(&quot;{{poster}}&quot;) 0% 0% / cover no-repeat; top: 0px; right: 0px;">',
